  ...
  return (
    <div className="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-lg">
      ...
      <div className="flex flex-1 flex-col p-4">
        <h3 className="line-clamp-1 font-bold text-slate-900 group-hover:text-primary">
          {trip.title}
        </h3>
        ...
        <div className="mt-3 flex items-center justify-between border-t border-slate-100 pt-3">
          ...
          <Link
            href={`/trips/${trip._id}`}
            className="cursor-pointer rounded-lg bg-primary px-3.5 py-2 text-xs font-bold text-white transition-colors duration-200 hover:bg-primary-dark"
          >
            View Details
          </Link>
        </div>
