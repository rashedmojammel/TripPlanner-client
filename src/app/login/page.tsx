  ...
  return (
    <AuthShell title="Welcome back" subtitle="Log in to continue planning your next trip">
      ...
      <button
        onClick={handleDemo}
        disabled={loading}
        className="mt-3 flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border-2 border-dashed border-secondary/50 bg-secondary/5 py-3 text-sm font-bold text-secondary transition-colors duration-200 hover:bg-secondary/10"
      >
